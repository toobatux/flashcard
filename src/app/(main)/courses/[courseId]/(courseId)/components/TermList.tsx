    ...
    <>
      <div className="relative w-full">
        <div className="flex flex-col w-full">
          {terms.length > 0 && (
            <>
              <div className="flex w-full justify-center items-center rounded-xl border-2 bg-white dark:bg-transparent dark:border-white/5 px-5 py-4 mt-8 mb-3">
          ...
          {terms.length === 0 && (
            <div className="p-5 bg-blue-600 bg-opacity-10 text-blue-200 rounded-lg mt-8">
              <div className="flex gap-1.5 items-center mb-2">
                <InfoOutlined fontSize="small" />
                <div className="font-semibold text-md">
                  This lesson has no terms
                </div>
              </div>
              <div className="text-sm">Edit the lesson to add terms</div>
            </div>
          )}
        </div>
      </div>
