...
const KeyboardMessage = () => {
  ...
  return (
    isVisible && (
      ...
      <div className="p-3 bg-blue-600 bg-opacity-10 text-blue-200 rounded-lg">
        <div className="flex items-center justify-between">
          ...
          >
            <div className="flex items-center p-2 rounded-full text-blue-200 hover:bg-white/10 transition-colors">
              <Close />
            </div>
          </button>
        </div>
