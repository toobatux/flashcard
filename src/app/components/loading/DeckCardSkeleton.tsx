const DeckCardSkeleton = () => {
  return (
    <div className="text-sm relative h-[140px] p-4 bg-white/5 hover:bg-white/10 group rounded-xl shadow-lg transition-all flex flex-col justify-between">
      <div>
        <div className="h-[18px] w-full bg-white/5 rounded-full animate-pulse mb-1"></div>
        <div className="h-[18px] w-1/2 bg-white/5 rounded-full animate-pulse"></div>
      </div>
      ...
      <div className="flex items-center text-white/60">
        ...
        <div className="h-[20px] w-1/4 bg-white/5 rounded-full animate-pulse"></div>
      </div>
    </div>
  );
};
